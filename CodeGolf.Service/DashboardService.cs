    ...
    public class DashboardService : IDashboardService
    {
                         ...
                         async some =>
                             {
                                 ...
                                 await this.holeRepository.Update(some);
                                 return some.HoleId;
                             });
        ...
        private async Task<Option<Hole>> GetNextHole(Guid gameId, CancellationToken cancellationToken)
        {
            ...
            return await currentHole.Match(
                some => Task.FromResult(this.gameRepository.GetAfter(some.HoleId)),
                async () => (await this.holeRepository.GetGameHoles(gameId)).FirstOrNone());
        }
